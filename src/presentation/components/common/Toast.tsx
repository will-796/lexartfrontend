...
import { Toast as PrimeToast, ToastProps as PrimeToastProps, ToastPassThroughMethodOptions } from 'primereact/toast'
import { classNames } from 'primereact/utils'
import { RefObject } from 'react'

type ToastProps = PrimeToastProps & {
  inputRef?: RefObject<PrimeToast>
}
export const Toast = ({
  inputRef,
  ...props
